package com.cjqb.caijiqianbao.glide;
...
//    }
    ...
    public static void display2(Context context, String url, ImageView imageView) {
        ...
        Glide.with(context).asDrawable().load(url).skipMemoryCache(true) .diskCacheStrategy(DiskCacheStrategy.NONE).into(imageView);
    }
